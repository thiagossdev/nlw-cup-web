...
import usersAvatarExamples from '../assets/users-avatar-examples.png';
...
export default function Home(props: HomeProps) {
  ...
  return (
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-20 items-center'>
      <main>
        <Image src={brandImg} alt='NLW Copa' />
        <h1 className='mt-14 text-white text-5xl font-bold leading-tight'>
          Crie seu próprio bolão da copa e compartilhe entre amigos!
        </h1>

        <div className='mt-10 flex items-center gap-2'>
          <Image src={usersAvatarExamples} alt='' />
      ...
      <Image
        src={appPreviewImg}
        alt='Dois celulares exibindo uma previa da aplicação módel do NLW Copa'
        quality={100}
      />
    </div>
  )
